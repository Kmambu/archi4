	...
	: public sc_core::sc_module
{
	enum coprocessor_fsm_state_e {
        READ_OPA, READ_OPB, COMPARE, DECR_A, DECR_B, WRITE_RES
	};

	// Registers
    sc_signal<uint32_t> r_opa;
    sc_signal<uint32_t> r_opb;
    sc_signal<int> r_fsm;
...
public:
	...
	sc_in<bool> p_resetn;
    sc_in<bool> p_clk;
    struct FifoInput<uint32_t> p_in;
    struct FifoOutput<uint32_t> p_out;
