...
#define	icache_words 4
#define	dcache_ways	1
#define	dcache_sets	512
#define	dcache_words 4
...
int _main(int argc, char *argv[])
{
	...
	proc = new VciXcacheWrapper<vci_param, Mips32ElIss>("proc", 0, maptab, IntTab(0), icache_ways, icache_sets, icache_words, dcache_ways, dcache_sets, dcache_words);
	...
	tty = new VciMultiTty<vci_param>("tty", IntTab(TGTID_TTY), maptab, "wololo!", NULL);

	std::cout << "DEBUUUUHG" << std::endl;
