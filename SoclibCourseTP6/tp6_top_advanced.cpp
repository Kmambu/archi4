...
int _main(int argc, char *argv[])
{
    ...
    int     wbuf_nwords         = 4;                // number of words per line of write_buffer
    int     wbuf_nlines         = 8;                // number of lines in write_buffer
    ...
    if (argc > 1)
    {
        for( int n=1 ; n<argc ; n=n+2 )
        {
            ...
            else
            {
                ...
                std::cout << "   -WBUFW number of words per line of wbuf" << std::endl;
                std::cout << "   -LATENCY number of lines in wbuf" << std::endl;
                exit(0);
            }
        }
    }
