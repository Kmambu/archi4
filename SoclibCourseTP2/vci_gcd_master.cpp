...
void VciGcdMaster<vci_param>::genMoore()
{
	...
	p_vci.trdid	        = 1;		// unused
	p_vci.pktid	        = 1;		// unused
	...
	case RSP_STATUS :
		p_vci.cmdval	= false;
		p_vci.cmd	    = vci_param::CMD_NOP; // unused
		p_vci.address	= m_base; // unused
		p_vci.wdata	    = 0x00000000; // unused
		p_vci.rspack	= true;
		break; 
     } // end switch
